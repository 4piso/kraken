...
exports.register = (plugin, options, next) => {
    ...
    plugin.route([
        ...
        { method: 'GET', path: '/reservation/searchbydate/{_datetime}', config: Controllers.Reservation.searchByDate },
        ...
        { method: 'GET', path: '/vendor/getvendor/{_id}', config: Controllers.Vendor.readVendor }
    ]);
